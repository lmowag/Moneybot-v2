...
extern "C" {
#endif
void lua_output_redirect(const char* s, size_t l);
void lua_line_redirect();
#ifdef __cplusplus
}
#endif

#define lua_writestring(s,l) lua_output_redirect(s,l)
#define lua_writeline() lua_line_redirect()
