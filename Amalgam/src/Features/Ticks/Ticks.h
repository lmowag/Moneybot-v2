...
private:
  ...
  bool m_bTimingUnsure =
      false; // we aren't sure when we'll actually fire, hold aim
...
public:
  ...
  void AntiWarp(CTFPlayer *pLocal, float flYaw, float &flForwardMove,
  ...
  int GetShotsWithinPacket(CTFWeaponBase *pWeapon,
